...
<section>
  <div class="hero-slider position-relative">
    <div class="hero-slider-item py-160" style="background-image: url(resources/images/banner/banner-1.jpg);"
    ...
    <div class="hero-slider-item py-160" style="background-image: url(resources/images/banner/banner-2.jpg);"
    ...
    <div class="hero-slider-item py-160" style="background-image: url(resources/images/banner/banner-3.jpg);" data-icon="ti-money"
      data-text="Finance">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
    ...
    <div class="hero-slider-item py-160" style="background-image: url(resources/images/banner/banner-4.jpg);"
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card text-center">
          ...
          <div class="card-img-wrapper">
            <img class="card-img-top rounded-0" src="resources/images/service/service-1.jpg" alt="service-image">
          </div>
      ...
      <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
        <div class="card text-center">
          ...
          <div class="card-img-wrapper">
            <img class="card-img-top rounded-0" src="resources/images/service/service-2.jpg" alt="service-image">
          </div>
          <div class="card-body p-0">
      ...
      <div class="col-lg-4 col-sm-6">
        <div class="card text-center">
          ...
          <div class="card-img-wrapper">
            <img class="card-img-top rounded-0" src="resources/images/service/service-3.jpg" alt="service-image">
          </div>
          <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="mb-5 mb-md-0 text-center text-md-left">
                        <!-- logo -->
                        <img class="mb-30" src="resources/images/logo-footer.png" alt="logo">
